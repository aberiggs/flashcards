...
export function CardPreview({ front, index, onClick }: CardPreviewProps) {
    return (
        <button
            type="button"
            onClick={onClick}
            className="group h-[140px] w-full text-left rounded-xl border border-border-primary bg-surface-primary p-5 shadow-sm
        ...
        >
            <div className="flex flex-col h-full">
                <span className="text-[11px] font-medium text-text-tertiary mb-2 uppercase tracking-wider">
                    Card {index + 1}
                </span>

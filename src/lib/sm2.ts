 ...
 *
 * Pure logic — works with millisecond timestamps (epoch ms). Convert to/from
 * Date / timestamptz at the DB boundary.
 */
...
/**
 * Compute updated SRS state and next review timestamp (epoch ms) from a review.
 */
